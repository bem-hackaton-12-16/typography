var assert = require('assert'),
    ...
    referencesJSON = JSON.stringify(require('./blockquote.references.js')),
...
describe('blockquote (common.tmpl-specs)', function() {
...
var engine = loadTemplate("./blockquote.bemhtml.js", "BEMHTML");
...
}); // /describe blockquote (common.tmpl-specs)
