var assert = require('assert'),
    ...
    referencesJSON = JSON.stringify(require('./paragraph.references.js')),
...
describe('paragraph (common.tmpl-specs)', function() {
...
var engine = loadTemplate("./paragraph.bemhtml.js", "BEMHTML");
...
}); // /describe paragraph (common.tmpl-specs)
