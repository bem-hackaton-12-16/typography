var assert = require('assert'),
    ...
    referencesJSON = JSON.stringify(require('./list.references.js')),
...
describe('list (common.tmpl-specs)', function() {
...
var engine = loadTemplate("./list.bemhtml.js", "BEMHTML");
...
}); // /describe list (common.tmpl-specs)
